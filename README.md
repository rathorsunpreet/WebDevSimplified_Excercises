...
Import **schema.sql** file and run it. (This file contains the code necessary to create and add the tables from the tutorial video)

## Exercises
The following is taken from [README.md](https://github.com/WebDevSimplified/Learn-SQL/blob/master/README.md) to list all the excercises.

My Solutions are in the **Answers** folder and are named as **Solution_x.sql**.
...
After successfully creating the table, run **data.sql** to populate all of the data for the rest of the exercises. If you do not encounter any errors, then your answer is most likely correct.
